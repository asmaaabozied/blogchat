...
<script src="{{asset('admins/assets/js/forms/bootstrap_validation/bs_validation_script.js')}}"></script>
<script src="{{asset('admins/plugins/bootstrap-select/bootstrap-select.min.js')}}"></script>
